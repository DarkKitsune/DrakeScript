...
namespace DrakeScript
{
	public struct ASTNode
	{
		...
		public static Dictionary<NodeType, NodeInfo> NodeInfo = new Dictionary<NodeType, NodeInfo>()
		{
			...
			{NodeType.MethodCall, new NodeInfo(true)},
			...
			{NodeType.PairOperator, new NodeInfo(false, true, false, NodeType.Pair, 2)},
            {NodeType.TablePairOperator, new NodeInfo(false, true, false, NodeType.TablePair, 15)},
            ...
            {NodeType.ThreadOperator, new NodeInfo(false, false, true, NodeType.Thread, 3)},
            {NodeType.EqualsOperator, new NodeInfo(false, true, false, NodeType.Eq, 8)},
            {NodeType.SeqEqualsOperator, new NodeInfo(false, true, false, NodeType.SEq, 8)},
			...
			{NodeType.SetOperator, new NodeInfo(false, true, false, NodeType.Set, 16)},
			{NodeType.PlusEqOperator, new NodeInfo(false, true, false, NodeType.PlusEq, 16)},
			{NodeType.MinusEqOperator, new NodeInfo(false, true, false, NodeType.MinusEq, 16)},
