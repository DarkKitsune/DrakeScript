...
namespace DrakeScript
{
	public struct ASTNode
	{
		...
		public static Dictionary<NodeType, NodeInfo> NodeInfo = new Dictionary<NodeType, NodeInfo>()
		{
			...
			{NodeType.IsOperator, new NodeInfo(false, true, false, NodeType.Is, 5)},
			{NodeType.ThenOperator, new NodeInfo(false, true, false, NodeType.Then, 13)},
			{NodeType.OtherwiseOperator, new NodeInfo(false, true, false, NodeType.Otherwise, 13)},
			{NodeType.ContainsOperator, new NodeInfo(false, true, false, NodeType.Contains, 5)},
			...
			{NodeType.ModuloOperator, new NodeInfo(false, true, false, NodeType.Modulo, 3)},
			{NodeType.PowerOperator, new NodeInfo(false, true, false, NodeType.Power, 3)},
			...
			{NodeType.OrOperator, new NodeInfo(false, true, false, NodeType.Or, 12)},
			{NodeType.AndOperator, new NodeInfo(false, true, false, NodeType.And, 11)},
